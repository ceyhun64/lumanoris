...
export default function MarketCard({ bot, onRemove }) {
  ...
  const addBotToCart = async (orderWeeks = 4) => {
    const formData = new FormData();
    formData.append("data", JSON.stringify({ chatbot_id: bot.id, order_weeks: orderWeeks }));
    const res = await fetch("/api/marketplace/addtocart.php", {
      method: "POST",
      body: formData,
      credentials: "include",
    });
  ...
  const handleAddToCart = async (e) => {
    e.stopPropagation();
    try {
      const result = await addBotToCart();
      if (result.success) {
        setCartAdded(true);
        setIsInCart(true);
    ...
    >
                ...
                <ul className="list-none flex flex-col gap-3">
                  ...
                  >
                    <span className="flex items-center justify-center">
                      ...
                      >
                        <path
                          d="M16 3.5H8C7.46957 3.5 6.96086 3.71071 6.58579 4.08579C6.21071 4.46086 6 4.96957 6 5.5V21.5L12 18.5L18 21.5V5.5C18 4.96957 17.7893 4.46086 17.4142 4.08579C17.0391 3.71071 16.5304 3.5 16 3.5Z"
                          stroke="#E879F9"
                          strokeWidth="2"
                          strokeLinecap="round"
                  ...
                  >
                    <span className="flex items-center justify-center">
                      ...
                      >
                        <path
                          opacity="0.3"
                          d="M18 6.5C18.5523 6.5 19 6.05228 19 5.5C19 4.94772 18.5523 4.5 18 4.5C17.4477 4.5 17 4.94772 17 5.5C17 6.05228 17.4477 6.5 18 6.5Z"
                          fill="#E879F9"
                        />
                        <path
                          opacity="0.3"
                          d="M6 13.5C6.55228 13.5 7 13.0523 7 12.5C7 11.9477 6.55228 11.5 6 11.5C5.44772 11.5 5 11.9477 5 12.5C5 13.0523 5.44772 13.5 6 13.5Z"
                          fill="#E879F9"
                        />
                        <path
                          opacity="0.3"
                          d="M18 20.5195C18.5523 20.5195 19 20.0718 19 19.5195C19 18.9672 18.5523 18.5195 18 18.5195C17.4477 18.5195 17 18.9672 17 19.5195C17 20.0718 17.4477 20.5195 18 20.5195Z"
                          fill="#E879F9"
                        />
                        <path
                          d="M18 16.58C17.24 16.58 16.56 16.88 16.04 17.35L8.91 13.2C8.96 12.97 9 12.74 9 12.5C9 12.26 8.96 12.03 8.91 11.8L15.96 7.69C16.5 8.19 17.21 8.5 18 8.5C19.66 8.5 21 7.16 21 5.5C21 3.84 19.66 2.5 18 2.5C16.34 2.5 15 3.84 15 5.5C15 5.74 15.04 5.97 15.09 6.2L8.04 10.31C7.5 9.81 6.79 9.5 6 9.5C4.34 9.5 3 10.84 3 12.5C3 14.16 4.34 15.5 6 15.5C6.79 15.5 7.5 15.19 8.04 14.69L15.16 18.85C15.11 19.06 15.08 19.28 15.08 19.5C15.08 21.11 16.39 22.42 18 22.42C19.61 22.42 20.92 21.11 20.92 19.5C20.92 17.89 19.61 16.58 18 16.58Z"
                          fill="#E879F9"
                        />
                      </svg>
                    </span>
                    ...
                    <span className="flex items-center justify-center">
                      ...
                      >
                        ...
                        <path
                          ...
                          fillRule="evenodd"
                          clipRule="evenodd"
                          d="M2.96808 15.7652C3.16134 15.7737 3.35039 15.7071 3.49574 15.5795C3.64109 15.4518 3.7315 15.273 3.74808 15.0802L4.71808 3.84422C4.73451 3.6769 4.71666 3.50799 4.66562 3.3478C4.61458 3.18761 4.53142 3.0395 4.42122 2.91253C4.31102 2.78555 4.17609 2.68237 4.02468 2.6093C3.87327 2.53622 3.70855 2.49477 3.54058 2.48749C3.37261 2.48021 3.20492 2.50724 3.04775 2.56694C2.89058 2.62664 2.74723 2.71775 2.62646 2.83471C2.50568 2.95167 2.41002 3.09203 2.3453 3.2472C2.28059 3.40237 2.24819 3.56911 2.25008 3.73722V15.0162C2.2499 15.2097 2.32451 15.3958 2.45832 15.5356C2.59212 15.6753 2.77476 15.757 2.96808 15.7652Z"
                          fill="#E879F9"
                        />
                      </svg>
                    </span>
                  ...
                  >
                    <span className="flex items-center justify-center">
                      ...
                      >
                        <path
                          opacity="0.3"
                          d="M9.1 5.5L5 9.6V15.4L9.1 19.5H14.9L19 15.4V9.6L14.9 5.5H9.1ZM12 17.5C11.45 17.5 11 17.05 11 16.5C11 15.95 11.45 15.5 12 15.5C12.55 15.5 13 15.95 13 16.5C13 17.05 12.55 17.5 12 17.5ZM13 14.5H11V7.5H13V14.5Z"
                          fill="#E879F9"
                        />
                        <path
                          d="M15.73 3.5H8.27L3 8.77V16.23L8.27 21.5H15.73L21 16.23V8.77L15.73 3.5ZM19 15.4L14.9 19.5H9.1L5 15.4V9.6L9.1 5.5H14.9L19 9.6V15.4Z"
                          fill="#E879F9"
                        />
                        <path
        ...
        <div className="flex justify-between items-center gap-3 w-full">
          ...
          <button
            className={cn(
              ...
              liked ? "text-fuchsia-400" : "text-white/50 hover:text-white/80",
            )}
            onClick={handleLike}
          >
      ...
      <AddToListModal
        ...
        onCreateList={(listName) =>
          console.log(`"${bot.title}" botu "${listName}" listesine eklendi`)
        }
      />
      <CommentModal
        isOpen={commentOpen}
        ...
        comments={[
          {
            text: "Harika bir model olmuş",
            author: "adnankocak",
            date: "2 gün önce",
          },
          {
            text: "Gerçekten faydalı bir model",
            author: "ahmetyasin",
            date: "2 gün önce",
          },
          {
