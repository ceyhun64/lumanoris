...
export default function MarketCard({ bot, onRemove }) {
    ...
    return (
        <div
            className={cn(
                'relative flex flex-col cursor-pointer p-3 rounded-lg border bg-[#0D0D1A] gap-3 justify-between transition-all duration-300 hover:shadow-[0_0_12px_rgba(99,102,241,0.25)]',
                isInCart ? 'border-indigo-400/50' : 'border-[rgba(255,241,250,0.2)]',
            )}
        ...
        >
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="200" height="161" viewBox="0 0 200 161" fill="none" className="w-full">
                        ...
                        <defs>
                            ...
                            <linearGradient id="mc_grad" x1="31.7" y1="-4.5" x2="170.4" y2="-4.5" gradientUnits="userSpaceOnUse">
                                ...
                                <stop offset="0.79" stopColor="#22D3EE" />
                            </linearGradient>
                        </defs>
                    </svg>
                </div>
            ...
            <div className="relative w-full z-[1]">
                ...
                <Image
                    ...
                    width={300}
                    height={300}
                    className="w-full aspect-square object-cover rounded-t-lg outline outline-1 outline-white/15 -outline-offset-1 relative z-[1]"
                />
            </div>
            ...
            <div className="flex flex-col items-start w-full z-[2]">
                        ...
                        {menuOpen && (
                            ...
                            >
                                <ul className="list-none flex flex-col gap-3">
                                    <li
                                        className="flex items-center gap-3 py-3 cursor-pointer transition-all text-white font-display text-base font-medium hover:translate-x-1 hover:text-indigo-400"
                                        onClick={(e) => { e.stopPropagation(); setModalVisible(true); }}
                                    >
                                        <span className="flex items-center justify-center">
                                            <svg width="24" height="25" viewBox="0 0 24 25" fill="none">
                                                <path d="M16 3.5H8C7.46957 3.5 6.96086 3.71071 6.58579 4.08579C6.21071 4.46086 6 4.96957 6 5.5V21.5L12 18.5L18 21.5V5.5C18 4.96957 17.7893 4.46086 17.4142 4.08579C17.0391 3.71071 16.5304 3.5 16 3.5Z" stroke="#818CF8" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                                            </svg>
                                        </span>
                                        Listeye Kaydet
                                    </li>
                                    ...
                                    >
                                        <span className="flex items-center justify-center">
                                            <svg width="24" height="25" viewBox="0 0 24 25" fill="none">
                                                <path opacity="0.3" d="M18 6.5C18.5523 6.5 19 6.05228 19 5.5C19 4.94772 18.5523 4.5 18 4.5C17.4477 4.5 17 4.94772 17 5.5C17 6.05228 17.4477 6.5 18 6.5Z" fill="#818CF8" />
                                                <path opacity="0.3" d="M6 13.5C6.55228 13.5 7 13.0523 7 12.5C7 11.9477 6.55228 11.5 6 11.5C5.44772 11.5 5 11.9477 5 12.5C5 13.0523 5.44772 13.5 6 13.5Z" fill="#818CF8" />
                                                <path opacity="0.3" d="M18 20.5195C18.5523 20.5195 19 20.0718 19 19.5195C19 18.9672 18.5523 18.5195 18 18.5195C17.4477 18.5195 17 18.9672 17 19.5195C17 20.0718 17.4477 20.5195 18 20.5195Z" fill="#818CF8" />
                                                <path d="M18 16.58C17.24 16.58 16.56 16.88 16.04 17.35L8.91 13.2C8.96 12.97 9 12.74 9 12.5C9 12.26 8.96 12.03 8.91 11.8L15.96 7.69C16.5 8.19 17.21 8.5 18 8.5C19.66 8.5 21 7.16 21 5.5C21 3.84 19.66 2.5 18 2.5C16.34 2.5 15 3.84 15 5.5C15 5.74 15.04 5.97 15.09 6.2L8.04 10.31C7.5 9.81 6.79 9.5 6 9.5C4.34 9.5 3 10.84 3 12.5C3 14.16 4.34 15.5 6 15.5C6.79 15.5 7.5 15.19 8.04 14.69L15.16 18.85C15.11 19.06 15.08 19.28 15.08 19.5C15.08 21.11 16.39 22.42 18 22.42C19.61 22.42 20.92 21.11 20.92 19.5C20.92 17.89 19.61 16.58 18 16.58Z" fill="#818CF8" />
                                            </svg>
                                        </span>
                                        Paylaş
                                    </li>
                                    ...
                                    >
                                        <span className="flex items-center justify-center">
                                            <svg width="24" height="25" viewBox="0 0 24 25" fill="none">
                                                <path opacity="0.3" d="M9.1 5.5L5 9.6V15.4L9.1 19.5H14.9L19 15.4V9.6L14.9 5.5H9.1ZM12 17.5C11.45 17.5 11 17.05 11 16.5C11 15.95 11.45 15.5 12 15.5C12.55 15.5 13 15.95 13 16.5C13 17.05 12.55 17.5 12 17.5ZM13 14.5H11V7.5H13V14.5Z" fill="#818CF8" />
                                                <path d="M15.73 3.5H8.27L3 8.77V16.23L8.27 21.5H15.73L21 16.23V8.77L15.73 3.5ZM19 15.4L14.9 19.5H9.1L5 15.4V9.6L9.1 5.5H14.9L19 9.6V15.4Z" fill="#818CF8" />
                                                <path d="M12 17.5C12.5523 17.5 13 17.0523 13 16.5C13 15.9477 12.5523 15.5 12 15.5C11.4477 15.5 11 15.9477 11 16.5C11 17.0523 11.4477 17.5 12 17.5Z" fill="#818CF8" />
                                                <path d="M11 7.5H13V14.5H11V7.5Z" fill="#818CF8" />
                                            </svg>
                                        </span>
                                        Bildir
                                    </li>
                ...
                <div className="flex justify-between items-center gap-3 w-full">
                    {/* Like */}
                    <button
                        className={cn('flex items-center gap-1 transition-colors', liked ? 'text-indigo-400' : 'text-white/50 hover:text-white/80')}
                        onClick={handleLike}
                    >
                    ...
                    {/* Buy button */}
                    <button
                        className="flex px-3 py-0.5 cursor-pointer justify-center items-center rounded-xl text-white text-center font-display text-[7px] font-medium min-w-[50px] transition-all bg-gradient-to-br from-[#3730A3] to-[#06B6D4]/20 hover:from-[#6366F1] hover:to-[#06B6D4] border-none outline-none"
                        onClick={e => {
                            e.stopPropagation();
                            const botItem = { ...bot, id: `${bot.id}-${bot.title}-${bot.author}` };
                            let cart = [];
                ...
                <div className="flex items-center justify-between gap-2 mt-3 text-[8px] font-medium w-full text-[#62647C]">
                    ...
                    <div className="ml-auto text-white rounded-xl font-display text-[7px] font-medium py-[1px] px-3 flex items-center justify-center shadow-[0_4px_14px_0_rgba(99,102,241,0.2)] border border-white/[0.133] min-w-[50px]">
                        {priceType === "USD" ? "$" : ""}{price}
                    </div>
                </div>
            </div>
