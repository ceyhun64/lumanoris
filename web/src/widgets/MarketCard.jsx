            ...
            <div className="flex flex-col items-start w-full z-[2]">
                ...
                <div className="flex flex-row justify-between items-center w-full mb-3">
                    ...
                    <div className="relative shrink-0" ref={menuRef}>
                        ...
                        {menuOpen && (
                            <div
                                className="absolute bottom-20 left-1/2 -translate-x-1/2 py-3 px-6 w-[280px] z-[99999] rounded-3xl bg-[#111120] shadow-[0_8px_32px_rgba(0,0,0,0.6)]"
                ...
                <div className="flex justify-between items-center gap-3 w-full">
                    {/* Like */}
                    <button
                        className={cn('flex items-center gap-1 transition-colors', liked ? 'text-[#FF99D6]' : 'text-[#FFE6F2]/70 hover:text-[#FFE6F2]')}
                        onClick={handleLike}
                    >
                    ...
                    {/* Comment */}
                    <button
                        className="flex items-center gap-1 text-[#FFE6F2]/70 hover:text-[#FFE6F2] transition-colors"
                    ...
                    {/* Buy button */}
                    <button
                        className="flex px-3 py-0.5 cursor-pointer justify-center items-center rounded-xl text-white text-center font-display text-[7px] font-medium min-w-[50px] transition-all bg-gradient-to-br from-[#3730A3] to-[#06B6D4]/20 hover:from-[#FF99D6] hover:to-[#FF99D6] border-none outline-none"
                        onClick={e => {
                            e.stopPropagation();
                            const botItem = { ...bot, id: `${bot.id}-${bot.title}-${bot.author}` };
                            let cart = [];
