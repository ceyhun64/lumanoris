...
export default function CategoryFilter({ categories, onSelect, selected: externalSelected, className, bare = false }) {
    ...
    return (
        <div className={cn("relative", bare ? "" : "mt-3", className)}>
            <div className={cn(
                ...
                bare ? "py-1" : "rounded-2xl border border-white/[0.06] bg-white/[0.02] p-2",
            )}>
