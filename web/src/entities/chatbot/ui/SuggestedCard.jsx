...
export default function SuggestedCard({ bot }) {
    ...
    return (
        <div
            className="relative flex flex-col cursor-pointer p-3 rounded-lg border border-[rgba(255,241,250,0.2)] bg-[#0D0D1A] gap-3 justify-between transition-all duration-300 hover:shadow-[0_0_12px_rgba(99,102,241,0.25)] hover:-translate-y-0.5"
            onClick={(e) => {
                        ...
                        {menuOpen && (
                            ...
                            >
                                <ul className="list-none flex flex-col gap-3">
                                    ...
                                    <li className="flex items-center gap-3 py-3 cursor-pointer transition-all text-white font-display text-base font-medium hover:translate-x-1 hover:text-indigo-400">
                                        <span className="flex items-center justify-center">
                                            <svg width="24" height="25" viewBox="0 0 24 25" fill="none">
