        ...
        <div className="flex flex-1 flex-col justify-between">
            ...
            <input type="file" id="profile-upload" accept="image/*" hidden onChange={(e) => handleFileUpload(e, 'profile')} />
                ...
                >
                    ...
                    <Upload className="h-9 w-9 text-pink-400" />
                ...
                {uploadedFiles.length > 0 && (
                    <div className="mb-4 flex flex-wrap gap-4">
                        {uploadedFiles.map((f, index) => (
                            <div key={index} className="relative min-w-[120px] rounded-lg border-2 border-pink-400 p-4">
                                ...
                                {f.url && f.type?.startsWith('image/') ? (
                                    ...
                                    <div className="text-center">
                                        <FileText className="mx-auto h-8 w-8 text-pink-400" />
                ...
                <textarea
                    ...
                    className={cn(
                        ...
                        promptGenerationStatus === 'processing' && "border-pink-400",
                    )}
                ></textarea>

                {formData.trainingPrompt && (
                    <div className="mb-4 mt-4 flex items-center justify-between gap-3 rounded-xl border border-dashed border-pink-400/40 bg-pink-400/[0.03] px-4 py-3 shadow-[0_2px_15px_rgba(0,0,0,0.1)]">
                        <div className="flex flex-1 items-center gap-2.5">
                            <div className="flex h-[34px] w-[34px] shrink-0 items-center justify-center rounded-lg bg-pink-400 text-white">
                                <FileText className="h-[18px] w-[18px]" />
                            </div>
                            <div>
                                <p className="text-[11px] font-extrabold uppercase text-pink-400">
