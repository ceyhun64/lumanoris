        ...
        <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
            <DialogContent className="max-w-[440px] bg-luma-card border-white/10 p-6 text-center">
                <div className="flex flex-col items-center">
                    <div className="mb-3 text-indigo-400" aria-hidden="true">
                    ...
                    <DialogTitle className="mb-2.5 text-xl font-semibold text-indigo-400">
                    ...
                    <div className="grid w-full grid-cols-2 gap-3">
                        ...
                        <button
                            ...
                            className="rounded-xl border border-indigo-400 bg-indigo-400/10 px-3 py-3 font-display text-[15px] font-medium text-indigo-400 transition-all duration-200 hover:border-indigo-300 hover:bg-indigo-400/20 hover:text-indigo-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
                        >
                            Devam Et
                        </button>
                    </div>
