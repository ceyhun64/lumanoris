            ...
            <DialogContent className="max-w-[440px] bg-luma-card border-white/10 p-6 text-center">
                <div className="flex flex-col items-center">
                    ...
                    <div className="grid w-full grid-cols-2 gap-3">
                        ...
                        <button
                            onClick={handleView}
                            className="rounded-xl border border-emerald-500 bg-emerald-500/10 px-3 py-3 font-display text-[15px] font-medium text-emerald-500 transition-all duration-200 hover:border-emerald-400 hover:bg-emerald-500/20 hover:text-emerald-400 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
                        >
                            Görüntüle
                        </button>
                    </div>
