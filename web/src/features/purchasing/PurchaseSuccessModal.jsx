...
export default function PurchaseSuccessModal({ isOpen, onClose, chatbotName = "Travel Planner AI" }) {
    ...
    return (
        <div className="quit-overlay" onClick={handleClose}>
            <div className="quit-modal" onClick={(e) => e.stopPropagation()}>
                ...
                <div className="modal-body">
                    ...
                    <h4 className="modal-title success">Satın Alma Başarılı</h4>
                    <p className="desc">{chatbotName} sohbetin aktif hale getirildi. Sahip olduğun chatbotlar arasında görüntüleyebilirsin.</p>

                    <div className="modal-actions">
                        <button className="cancel-btn" onClick={handleCancel}>İptal</button>
                        <button className="confirm-btn success" onClick={handleView}>Görüntüle</button>
                    </div>
                </div>
            </div>
        </div>
