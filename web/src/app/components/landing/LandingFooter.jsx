...
import { SITE_SOCIALS } from "@/shared/config/site";
...
/* Yalnızca shared/config/site.js'te doğrulanmış olarak duran hesaplar.
   Kaynaktaki üçüncü ikon (LinkedIn) `href="#"` idi — gerçek bir hesaba
   işaret etmediği için kaldırıldı. */
const SOCIALS = SITE_SOCIALS.map((url) => ({
  url,
  key: url.includes("instagram") ? "instagram" : "youtube",
  label: url.includes("instagram") ? "Instagram" : "YouTube",
}));
  ...
  return (
    <footer className="max-w-7xl mr-auto ml-auto pt-16 pr-5 pb-12 pl-5 sm:pt-20 sm:pr-6 sm:pl-6">
      <div className="grid gap-8 md:grid-cols-4">
        <div className="md:col-span-2">
          ...
          <p className="text-white/70 max-w-md mb-6">
            Kendi çok modlu yapay zekâ asistanlarınızı oluşturun, eğitin ve kolayca gelir modeline
            dönüştürün.
          </p>
      ...
      <div className="mt-12 pt-8 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        {/* Yasal linkler ve ödeme rozeti tek bir sağ blokta toplandı.
            Üçünü doğrudan justify-between'e bırakmak linkleri ortaya
            itiyordu; rozetin en sağda kalması için gruplandılar. */}
        <div className="flex flex-col items-center gap-4 sm:flex-row sm:gap-6">
          ...
          {/* Bandın beyaz varyantı kullanılıyor (logo_band_white), o yüzden
              koyu footer üzerinde plakasız duruyor. */}
