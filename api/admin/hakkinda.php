    ...
    <div class="max-w-screen-xl mx-auto">
        ...
        <form id="aboutForm" class="space-y-6" enctype="multipart/form-data">
            ...
            <div class="mt-4">
              ...
              <textarea id="hakkinda" name="hakkinda" rows="3" class="w-full border border-gray-300 rounded-lg px-4 py-2.5 bg-white focus:outline-none focus:ring-2 focus:ring-indigo-500 transition shadow-sm"></textarea>
            </div>
...
<script>
    ...
    ClassicEditor.create(document.querySelector('#hakkinda'), editorConfig)
        .then(editor => { 
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        editorInstance.setData(<?= json_encode($hakkinda_metini) ?>);
