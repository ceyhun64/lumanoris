...
import "./SellerOnboardingWizard.css";
...
export default function SellerOnboardingWizard({ userId, initialStatus, onComplete }) {
    ...
    const submit = async () => {
        ...
        try {
            ...
            const saveRes = await fetch("/api/save_bank_info.php", { method: "POST", body: fd });
            ...
            const regRes = await fetch("/api/submerchant_register.php", { method: "POST", body: regFd });
