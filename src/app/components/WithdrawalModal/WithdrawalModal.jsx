...
export default function WithdrawalModal({ isOpen, onClose, moneyAmount, userId }) {
    ...
    // Onay -> Başarı Modalını Aç
    const confirmWithdraw = () => {
        if (!pendingPayload) return;
        console.log("Para çekiliyor: ", pendingPayload);
        
        setShowConfirmModal(false);
        setShowSuccessModal(true); // ✅ Başarı popup'ını tetikle

        // 3 saniye sonra otomatik temizle ve kapat
        setTimeout(() => {
                    ...
                    <div className="quit-modal" onClick={(e) => e.stopPropagation()}>
                        ...
                        <div className="modal-body">
                            ...
                            <p className="desc">
                                ...
                                Ödeme süreci tamamlandığında hesabınıza yansıtılacaktır.
                            </p>
                            <div className="modal-actions">
