...
export default function BotCard({ bot, userId, onRemove }) {
    ...
    return (
        <div className="bot-card" onClick={() => router.push(`/dashboard/chat/?botId=${bot.id}`)}>
            ...
            <div className="info">
                        ...
                        {menuOpen && (
                            <div className="popup-menu">
                                <ul>
                                    ...
                                    <hr />
                                    <li onClick={handleNotInterested}><span><svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="meta text-sm">{dialogues} Diyalog · {time} önce yayımlandı</div>
            ...
            <AddToListModal userId={userId} botId={bot.id}
                isOpen={modalVisible}
